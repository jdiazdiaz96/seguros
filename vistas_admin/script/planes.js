            ...
            if (response.status == 1) {
                ...
                response.data.forEach(element => {
                    html += `<tr>  <td scope="row">${element.id}</td>
                                    ...
                                    <td scope="row"><a type="button" data-bs-toggle="modal" 
                                    data-bs-target="#editarModal" onclick='editar("${element.id}")' 
                                    class='btn btn-warning' role='button'><i class="bi bi-pencil-square">
                                        </i> Modificar</a></td>
                               </tr>`;
                });
