...
class Usuario{
    ...
    public static function vivienda($fecha_inicio, $fecha_fin, $tipo_seguro, $num_documento, $tipo_documento, $nombres, $email, $fecha_nacimiento, $sexo, $estado_civil, $celular, $direccion, $ciudad, $ingreso, $profesion, $medicamento, $cual, $eps_ips, $id_usuario){

        $db = self::$instance;

        $sql="SELECT * FROM cotizar WHERE tipo = 'vivienda'";
        $result =mysqli_query($db->dbcon,$sql);
