...
<body background="../public/img/seguro_fondo.jpg">
<header>
    <!-- place navbar here -->
...
<main style="min-height: 100vh;">
    <h1 class="p-3 text-center" style="color: white;">Cotiza tu seguro de vida, vivienda o autos</h1>
    <section class="d-flex justify-content-center align-items-start gap-5 flex-wrap">
        <article class="rounded bg-secondary" style="width: 450px; height: 580px; box-shadow: 0 0 20px rgba(110, 235, 228, 0.973);">
            <form  method="post" id="formulario">
                ...
                <div class="mb-3 ms-4 me-4">
                    ...
                    <div class="d-grid gap-2 ms-4 me-4 mt-4">
                        <button type="submit" name="" id="" class="btn btn-success">Cotizar</button>
                    </div>
                </form>
                <div class="ms-4 me-4 mt-4">
                    <a href="../index.html" class="d-grid gap-2 text-decoration-none">
                        <button type="button" name="" id="" class="btn btn-danger">Volver</button>
                    </a>
                </div>
            </article>
            <article class="rounded bg-info" style="width: 450px; height: 350px; box-shadow: 0 0 20px rgba(0, 0, 0, 0.3);">
